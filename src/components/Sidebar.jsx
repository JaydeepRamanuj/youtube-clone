...
function Sidebar() {
  ...
  return (
    <>
      <div
        className={`${breakpoint < 992 ? "-left-full fixed" : "static"} ${
          toolVal.sidebarCollapse ? "min-w-[100px] " : "min-w-[230px] left-0"
        } z-10 md:relative p-2 pb-4 overflow-y-auto scrollable-element max-w-[230px] bg-black/90 top-[80px] h-full`}
      >
        {breakpoint < 992 && (
          <svg
            ...
            focusable="false"
            aria-hidden="true"
            className="px-1 mb-3 cursor-pointer"
            onClick={() => {
              navigate("/");
            }}
          >
