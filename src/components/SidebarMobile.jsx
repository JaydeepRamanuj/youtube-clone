...
function SidebarMobile() {
  ...
  return (
    <>
      <div
        className={`absolute top-0 p-4 overflow-y-auto scrollable-element max-w-[230px] bg-black/80 h-full backdrop-blur-md  z-20 ${
          isSidebarHidden ? "-left-full" : "left-0"
        }`}
      >
        <div className="flex gap-2 items-center">
          <span
            className="p-2 hover:bg-yellow-400/20 rounded-full cursor-pointer transition-all duration-200 text-gray-300"
